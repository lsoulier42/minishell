...
t_list			*new_cmd_el(char *name, char **args, t_redirection *r);
void			del_cmd(void *cmd_void);
int				parse_cmds(t_list *instructions);
int				create_args_tab(char ***args, t_list *tokens);
int				parse_one_pipe_cmds(t_list **tokens, t_redirection *r);
...
int				parse_one_redirection(t_list *tokens, t_redirection **r);
